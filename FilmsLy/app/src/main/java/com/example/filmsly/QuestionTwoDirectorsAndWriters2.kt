...
import kotlinx.android.synthetic.main.activity_question_two_directors_and_writers_2.pb_progressBar
...
import kotlinx.android.synthetic.main.activity_question_two_directors_and_writers_2.tv_progress
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener {
            ...
            if (id != -1) {
                ...
                val intent = Intent(this, QuestionTwoDirectorsAndWriters3::class.java)
