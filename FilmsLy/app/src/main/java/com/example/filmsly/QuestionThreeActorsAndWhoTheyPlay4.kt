...
import kotlinx.android.synthetic.main.activity_question_three_actors_and_who_they_play_4.pb_progressBar
...
import kotlinx.android.synthetic.main.activity_question_three_actors_and_who_they_play_4.tv_progress
...
//        tv_progress.text = "$currentPosition" + "/" + pb_progressBar.max
        ...
        btn_next.setOnClickListener {
            ...
            if (id != -1) {
                ...
                val intent = Intent(this, QuestionThreeActorsAndWhoTheyPlay5::class.java)
