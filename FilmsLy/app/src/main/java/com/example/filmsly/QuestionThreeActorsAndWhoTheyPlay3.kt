...
import kotlinx.android.synthetic.main.activity_question_three_actors_and_who_they_play_3.pb_progressBar
...
import kotlinx.android.synthetic.main.activity_question_three_actors_and_who_they_play_3.tv_progress
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener {
            ...
            if (id != -1) {
                ...
                val intent = Intent(this, QuestionThreeActorsAndWhoTheyPlay4::class.java)
