...
import kotlinx.android.synthetic.main.activity_question_one_famous_words_3.pb_progressBar
...
import kotlinx.android.synthetic.main.activity_question_one_famous_words_3.tv_progress
...
//        tv_progress.text = "$currentPosition" + "/" + pb_progressBar.max
        ...
        btn_next.setOnClickListener {
            ...
            if (id != -1) {
                ...
                val intent = Intent(this, QuestionOneFamousWords4::class.java)
